...
undead_face1  = 0x0000000000000000000000000000000000000000001c00000000000000000000
undead_face2  = 0x0000000000000000000000000000000000000000001c00000000000000000000
...
haradian_face_younger_1 = 0x000000003e00714036db6db6db6db6db00000000001db6db0000000000000000
haradian_face_young_1   = 0x000000003e00718636db6db6db6db6db00000000001db6db0000000000000000
haradian_face_middle_1  = 0x000000003e00720536db6db6db6db6db00000000001db6db0000000000000000
haradian_face_old_1     = 0x00000001fe00725136db6db6db6db6db00000000001db6db0000000000000000
haradian_face_older_1   = 0x00000001fe00729136db6db6db6db6db00000000001db6db0000000000000000

haradian_face_younger_2 = 0x000000000000700036db6db6db6db6db00000000001db6db0000000000000000
haradian_face_young_2   = 0x000000003e0074d136db6db6db6db6db00000000001db6db0000000000000000
haradian_face_middle_2  = 0x000000003e00750136db6db6db6db6db00000000001db6db0000000000000000
haradian_face_old_2     = 0x000000003e00758936db6db6db6db6db00000000001db6db0000000000000000
haradian_face_older_2   = 0x000000003e00730a36db6db6db6db6db00000000001db6db0000000000000000

haradian_girl_younger_1 = 0x000000003e00400736db6db6db6db6db00000000001db6db0000000000000000
haradian_girl_young_1   = 0x000000003e00400436db6db6db6db6db00000000001db6db0000000000000000
haradian_girl_middle_1  = 0x000000003e00400636db6db6db6db6db00000000001db6db0000000000000000

haradian_girl_younger_2 = 0x000000003e00300736db6db6db6db6db00000000001db6db0000000000000000
haradian_girl_young_2   = 0x000000003e00300136db6db6db6db6db00000000001db6db0000000000000000
haradian_girl_middle_2  = 0x000000003e00300636db6db6db6db6db00000000001db6db0000000000000000
...
#peasant - retainer - footman - man-at-arms -  knight
 ...
 ["sarranid_mamluke","Sarranid Mamluke","Sarranid Mamlukes",tf_mounted|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_gloves|tf_guarantee_helmet|tf_guarantee_horse|tf_guarantee_shield,0,0,fac_kingdom_6,
  ...
  ["sarranid_castle_guard","Castle Guard","Castle Guards",tf_guarantee_shield|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_helmet,0,0,fac_kingdom_1,
   ...
   def_attrib|level(25),wp_melee(135)|wp_throwing(100),knows_common|knows_shield_3|knows_ironflesh_3|knows_power_strike_3,swadian_face_middle_1, swadian_face_older_2],
##end of regular stuffffs

  ["haradian_recruit","Haradian escapee","Haradian escapees",tf_guarantee_boots|tf_guarantee_armor,0,0,fac_outlaws,
   [itm_club,itm_stones],
   def_attrib|level(2),wp(60),knows_common|knows_athletics_1,haradian_face_younger_1, haradian_face_middle_2],
 ["haradian_footman","Haradian Footman","Haradian Footmen",tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_shield,0,0,fac_commoners,
   [itm_bamboo_spear,itm_arabian_sword_a,itm_tab_shield_kite_a,itm_desert_turban,
    itm_skirmisher_armor,itm_turban,itm_sarranid_boots_a,itm_sarranid_boots_b],
   def_attrib|level(5),wp(75),knows_common|knows_athletics_2,haradian_face_young_1, haradian_face_old_2],
 ["haradian_veteran_footman","Haradian Veteran Footman","Haradian Veteran Footmen",tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_shield|tf_guarantee_helmet,0,0,fac_commoners,
   [itm_bamboo_spear,itm_arabian_sword_a,itm_arabian_sword_b,itm_tab_shield_kite_b,
    itm_sarranid_boots_b,itm_sarranid_warrior_cap,itm_sarranid_leather_armor,itm_jarid,itm_arabian_sword_a,itm_mace_3],
   def_attrib|level(10),wp_one_handed (85) | wp_two_handed (85) | wp_polearm (85) | wp_archery (75) | wp_crossbow (75) | wp_throwing (100),knows_common|knows_athletics_2|knows_power_throw_2|knows_ironflesh_1|knows_power_strike_2|knows_shield_2,haradian_face_young_1, haradian_face_old_2],
 ["haradian_infantry","Haradian Infantry","Haradian Infantries",tf_guarantee_shield|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_helmet,0,0,fac_commoners,
   [itm_sarranid_mail_shirt,itm_sarranid_mail_coif,itm_jarid,itm_sarranid_boots_c,itm_sarranid_boots_b,itm_sarranid_axe_a,itm_arabian_sword_b,itm_mace_3,itm_spear,itm_tab_shield_kite_c],
   def_attrib|level(20),wp_one_handed (105) | wp_two_handed (105) | wp_polearm (105) | wp_archery (75) | wp_crossbow (75) | wp_throwing (110),knows_common|knows_riding_3|knows_ironflesh_2|knows_power_strike_3|knows_shield_3 | knows_power_throw_3|knows_athletics_3,haradian_face_middle_1, haradian_face_old_2],
 ["haradian_guard","Haradian Defender","Haradian Defenders",tf_mounted|tf_guarantee_shield|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_helmet,0,0,fac_commoners,
   [itm_military_pick,itm_sarranid_two_handed_axe_a,itm_jarid,itm_scimitar_b,itm_war_spear,itm_mace_4,itm_sarranid_boots_d, itm_sarranid_boots_c,itm_arabian_armor_b,itm_sarranid_mail_coif,itm_sarranid_veiled_helmet,itm_mail_mittens,itm_leather_gloves,itm_tab_shield_kite_d],
   def_attrib|level(25),wp_one_handed (135) | wp_two_handed (135) | wp_polearm (135) | wp_archery (75) | wp_crossbow (75) | wp_throwing (140),knows_common|knows_shield_3|knows_ironflesh_3|knows_power_strike_4|knows_power_throw_4|knows_athletics_10,haradian_face_middle_1, haradian_face_older_2],
 ["haradian_paladin","Haradian Paladin","Haradian Paladins",tf_mounted|tf_guarantee_shield|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_helmet,0,0,fac_commoners,
   [itm_military_pick,itm_sarranid_two_handed_axe_a,itm_jarid,itm_scimitar_b,itm_war_spear,itm_mace_4,itm_sarranid_boots_d, itm_sarranid_boots_c,itm_arabian_armor_b,itm_winged_great_helmet,itm_sarranid_veiled_helmet,itm_mail_mittens,itm_tab_shield_kite_d],
   def_attrib|level(30),wp_one_handed (135) | wp_two_handed (135) | wp_polearm (135) | wp_archery (75) | wp_crossbow (75) | wp_throwing (140),knows_common|knows_shield_5|knows_ironflesh_5|knows_power_strike_5|knows_power_throw_5|knows_athletics_10,haradian_face_middle_1, haradian_face_older_2],
 ["haradian_skirmisher","Haradian Skirmisher","Haradian Skirmishers",tf_guarantee_ranged|tf_guarantee_boots|tf_guarantee_armor,0,0,fac_commoners,
   [itm_turban,itm_desert_turban,itm_skirmisher_armor,itm_jarid,itm_jarid,itm_arabian_sword_a,itm_spiked_club,itm_tab_shield_small_round_a,itm_sarranid_warrior_cap,itm_sarranid_boots_a],
   def_attrib|level(10),wp(80),knows_common|knows_riding_2|knows_power_throw_2|knows_ironflesh_1|knows_athletics_3,haradian_face_young_1, haradian_face_middle_2],
 ["haradian_archer","Haradian Archer","Haradian Archers",tf_guarantee_ranged|tf_guarantee_boots|tf_guarantee_armor,0,0,fac_commoners,
   [itm_arrows,itm_arrows,itm_nomad_bow,itm_arabian_sword_a,itm_archers_vest,itm_sarranid_boots_b,itm_sarranid_helmet1,itm_sarranid_warrior_cap,itm_turban,itm_desert_turban],
 ...
 ["haradian_master_archer","Haradian Hunter","Haradian Hunters",tf_guarantee_ranged|tf_mounted|tf_guarantee_boots|tf_guarantee_armor,0,0,fac_commoners,
   [itm_barbed_arrows,itm_barbed_arrows,itm_arabian_sword_b,itm_mace_3,itm_strong_bow,itm_nomad_bow,
    itm_arabian_armor_b,itm_sarranid_boots_c,itm_sarranid_boots_b,itm_sarranid_mail_coif],
   str_14 | agi_5 | int_4 | cha_4|level(24),wp_one_handed (100) | wp_two_handed (100) | wp_polearm (100) | wp_archery (130) | wp_crossbow (100) | wp_throwing (130),knows_common|knows_power_draw_4|knows_power_throw_4|knows_ironflesh_3|knows_athletics_5,haradian_face_middle_1, haradian_face_older_2],
 ["haradian_horseman","Haradian Horseman","Haradian Horsemen",tf_mounted|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_horse|tf_guarantee_shield,0,0,fac_commoners,
   [itm_lance,itm_arabian_sword_b,itm_scimitar_b,itm_mace_4,itm_tab_shield_small_round_b,
    itm_sarranid_mail_shirt,itm_sarranid_boots_c,itm_sarranid_boots_b, itm_sarranid_horseman_helmet,itm_leather_gloves,itm_arabian_horse_a,itm_courser,itm_hunter],
   def_attrib|level(20),wp_melee(100),knows_common|knows_riding_4|knows_ironflesh_2|knows_shield_2|knows_power_strike_3,haradian_face_young_1, haradian_face_old_2],
 ["haradian_mamluke","Haradian Rider","Haradian Riders",tf_mounted|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_gloves|tf_guarantee_horse|tf_guarantee_shield,0,0,fac_commoners,
   [itm_heavy_lance,itm_great_bardiche,itm_sarranid_two_handed_mace_1,itm_sarranid_cavalry_sword,itm_tab_shield_small_round_c,
    itm_mamluke_mail,itm_surcoat_over_mail,itm_heraldic_mail_with_surcoat,itm_coat_of_plates_red,itm_coat_of_plates,itm_cuir_bouilli,itm_sarranid_boots_d,itm_sarranid_boots_c,itm_sarranid_veiled_helmet,itm_warhorse_sarranid,itm_scale_gauntlets,itm_mail_mittens],
   def_attrib|level(27),wp_one_handed (150) | wp_two_handed (130) | wp_polearm (130) | wp_archery (75) | wp_crossbow (75) | wp_throwing (110),knows_common|knows_riding_6|knows_shield_5|knows_ironflesh_5|knows_power_strike_5,haradian_face_middle_1, swadian_face_older_2],

  ["haradian_surviver","Haradian Surviver","Haradian Survivers",tf_female|tf_guarantee_armor,0,0,fac_outlaws,
   [itm_club,itm_stones],
   def_attrib|level(1),wp(40),knows_common,haradian_girl_younger_1,haradian_girl_younger_2],
  ["safe_haradian","Safe Haradian","Safe Haradians",tf_female|tf_guarantee_armor,0,0,fac_commoners,
   ...
   def_attrib|level(5),wp(70),knows_common,haradian_girl_young_1,haradian_girl_young_2],
  ["healthy_haradian","Healthy Haradian","Healthy Haradians",tf_female|tf_guarantee_armor,0,0,fac_commoners,
   ...
   def_attrib|level(10),wp(85),knows_common|knows_power_strike_1,haradian_girl_middle_1,haradian_girl_middle_2],
  ["haradian_horsewoman","Haradian Horsewoman","Haradian Horsewomen",tf_female|tf_guarantee_armor,0,0,fac_commoners,
   [itm_bolts,itm_arrows,itm_light_crossbow,itm_short_bow,itm_crossbow,itm_nordic_shield,itm_hide_covered_round_shield,itm_hatchet,itm_hand_axe,itm_voulge,itm_fighting_pick,itm_club,itm_dress,itm_leather_jerkin, itm_skullcap, itm_wrapping_boots],
   def_attrib|level(16),wp(100),knows_common|knows_riding_3|knows_power_strike_2|knows_athletics_2|knows_ironflesh_1,haradian_girl_middle_1,haradian_girl_middle_2],
  ["haradian_at_arms","Haradian at Arms","Haradians at Arms",tf_female|tf_mounted|tf_guarantee_boots|tf_guarantee_armor,0,0,fac_commoners,
   ...
   def_attrib|level(24),wp(140),knows_common|knows_power_strike_3|knows_riding_5|knows_athletics_3|knows_ironflesh_2|knows_shield_2,haradian_girl_young_1,haradian_girl_middle_2],
  ["haradian_judge","Haradian Judge","Haradian Judges",tf_female|tf_mounted|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_gloves|tf_guarantee_shield|tf_guarantee_horse,0,0,fac_commoners,
   [itm_bolts,itm_sarranid_two_handed_mace_1,itm_great_bardiche,itm_plate_covered_round_shield,itm_tab_shield_small_round_c, itm_crossbow,itm_mamluke_mail,itm_surcoat_over_mail,itm_heraldic_mail_with_surcoat,itm_coat_of_plates_red,itm_cuir_bouilli,itm_plate_armor,itm_coat_of_plates,itm_plate_boots,itm_guard_helmet,itm_winged_great_helmet,itm_warhorse_sarranid,itm_leather_gloves],
   def_attrib|level(30),wp(150),knows_common|knows_power_strike_3|knows_riding_5|knows_athletics_5|knows_ironflesh_5|knows_shield_5,haradian_girl_young_1,haradian_girl_middle_2],
  ["haradian_chaser","Haradian Chaser","Haradian Chasers",tf_female|tf_mounted|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_gloves|tf_guarantee_shield|tf_guarantee_horse,0,0,fac_commoners,
   [itm_bolts,itm_sword_medieval_b,itm_sword_khergit_3,itm_plate_covered_round_shield,itm_tab_shield_small_round_c, itm_crossbow,itm_mamluke_mail,itm_surcoat_over_mail,itm_heraldic_mail_with_surcoat,itm_coat_of_plates_red,itm_cuir_bouilli,itm_plate_armor,itm_coat_of_plates,itm_plate_boots,itm_guard_helmet,itm_sarranid_veiled_helmet,itm_warhorse_sarranid,itm_leather_gloves],
   def_attrib|level(30),wp(150),knows_common|knows_power_strike_3|knows_riding_5|knows_athletics_5|knows_ironflesh_5|knows_shield_5,haradian_girl_young_1,haradian_girl_middle_2],



  ["macon_hoplite","Hoplite","Hoplites",tf_guarantee_all,0,0,fac_kingdom_7,
   [itm_awlpike,itm_javelin,itm_plate_boots,itm_steel_shield,itm_plate_armor],
   def_attrib|level(21),wp(135),knows_common,rhodok_face_middle_1, rhodok_face_younger_2],
  ["macon_band","Sacred Bander","Sacred Band",tf_guarantee_all,0,0,fac_kingdom_7,
   [itm_awlpike,itm_javelin,itm_plate_boots,itm_steel_shield,itm_plate_armor],
   def_attrib|level(30),wp(135),knows_common,rhodok_face_younger_1, rhodok_face_old_1],
  ["macon_prison_guard","Prison Guard","Prison Guards",tf_guarantee_all,0,0,fac_kingdom_7,
   [itm_awlpike,itm_javelin,itm_plate_boots,itm_steel_shield,itm_plate_armor],
   def_attrib|level(30),wp(135),knows_common,rhodok_face_middle_1, rhodok_face_younger_2],
  ["macon_castle_guard","Castle Guard","Castle Guards",tf_guarantee_all,0,0,fac_kingdom_7,
   [itm_awlpike,itm_javelin,itm_plate_boots,itm_steel_shield,itm_plate_armor],
   def_attrib|level(30),wp(135),knows_common,rhodok_face_middle_1, rhodok_face_younger_2],
  

  ["Settler","Settler","Settler",tf_guarantee_all,0,0,fac_kingdom_8,
   [itm_flintlock_pistol,itm_cartridges,itm_steel_shield,itm_one_handed_war_axe_a,itm_shirt,itm_linen_tunic,itm_short_tunic,itm_red_shirt,itm_coarse_tunic,itm_tabard,itm_tunic_with_green_cape,itm_gambeson,itm_blue_gambeson,itm_red_gambeson,itm_aketon_green],
   def_attrib|level(21),wp(135),knows_common,rhodok_face_younger_1, rhodok_face_younger_2],
  ["Conquistadore","Conquistadore","Conquistadore",tf_guarantee_all,0,0,fac_kingdom_8,
   [itm_flintlock_pistol,itm_cartridges,itm_steel_shield,itm_one_handed_war_axe_a,itm_haubergeon,itm_mail_hauberk,itm_mail_shirt,itm_plate_armor,itm_bascinet,itm_guard_helmet,itm_flat_topped_helmet,itm_full_helm],
   def_attrib|level(30),wp(135),knows_common,swadian_face_old_1, swadian_face_old_2],
  ["settler_prison_guard","Prison Guard","Prison Guards",tf_guarantee_all,0,0,fac_kingdom_8,
   [itm_flintlock_pistol,itm_cartridges,itm_steel_shield,itm_one_handed_war_axe_a,itm_haubergeon,itm_mail_hauberk,itm_mail_shirt,itm_plate_armor,itm_bascinet,itm_guard_helmet,itm_flat_topped_helmet,itm_full_helm],
   def_attrib|level(30),wp(135),knows_common,swadian_face_old_1, swadian_face_old_2],
  ["settler_castle_guard","Castle Guard","Castle Guards",tf_guarantee_all,0,0,fac_kingdom_8,
   [itm_flintlock_pistol,itm_cartridges,itm_steel_shield,itm_one_handed_war_axe_a,itm_haubergeon,itm_mail_hauberk,itm_mail_shirt,itm_plate_armor,itm_bascinet,itm_guard_helmet,itm_flat_topped_helmet,itm_full_helm],
   def_attrib|level(30),wp(135),knows_common,swadian_face_old_1, swadian_face_old_2],

##end of new faction trees
  ...
  ["black_khergit_horseman","Blood Khergit Horseman","Blood Khergit Horsemen",tf_mounted|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_horse,0,0,fac_black_khergits,
...
##   def_attrib|level(21),wp(100),knows_common|knows_riding_4,khergit_face1, khergit_face2],
  ...
  ["dark_knight","Dark knight","Dark knights",tf_female|tf_allways_fall_dead|tf_mounted|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_horse,0,0,fac_dark_knights,
   [itm_arrows,itm_bardiche,itm_scimitar,itm_two_handed_cleaver,itm_winged_mace,itm_spear,itm_khergit_sword_two_handed_a,itm_khergit_sword_two_handed_b,itm_war_bow,itm_black_helmet,itm_black_armor,itm_black_greaves,itm_plate_covered_round_shield,itm_saddle_horse],
   def_attrib|level(30),wp(100),knight_skills_5|knows_riding_3|knows_ironflesh_3|knows_horse_archery_3|knows_power_draw_3,refugee_face1,refugee_face2],
  ["dark_guard","Dark guard","Dark guard",tf_allways_fall_dead|tf_mounted|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_horse,0,0,fac_dark_knights,
   [itm_arrows,itm_bardiche,itm_scimitar,itm_two_handed_cleaver,itm_winged_mace,itm_spear,itm_khergit_sword_two_handed_a,itm_khergit_sword_two_handed_b,itm_war_bow,itm_black_helmet,itm_black_armor,itm_black_greaves,itm_plate_covered_round_shield,itm_saddle_horse],
   def_attrib|level(30),wp(100),knight_skills_5|knows_riding_3|knows_ironflesh_3|knows_horse_archery_3|knows_power_draw_3,khergit_face_young_1, khergit_face_old_2],
  ["black_knight","Dark knight","Dark knights",tf_female|tf_mounted|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_horse,0,0,fac_dark_knights,
   [itm_arrows,itm_bardiche,itm_scimitar,itm_two_handed_cleaver,itm_winged_mace,itm_spear,itm_khergit_sword_two_handed_a,itm_khergit_sword_two_handed_b,itm_war_bow,itm_black_helmet,itm_black_armor,itm_black_greaves,itm_plate_covered_round_shield,itm_saddle_horse],
   def_attrib|level(22),wp(140),knows_common|knows_power_strike_3|knows_riding_5|knows_athletics_3|knows_ironflesh_3|knows_horse_archery_3|knows_power_draw_3,refugee_face1,refugee_face2],
  ["black_guard","Dark guard","Dark guard",tf_mounted|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_horse,0,0,fac_dark_knights,
   [itm_arrows,itm_bardiche,itm_scimitar,itm_two_handed_cleaver,itm_winged_mace,itm_spear,itm_khergit_sword_two_handed_a,itm_khergit_sword_two_handed_b,itm_war_bow,itm_black_helmet,itm_black_armor,itm_black_greaves,itm_plate_covered_round_shield,itm_saddle_horse],
   def_attrib|level(22),wp(140),knows_common|knows_power_strike_3|knows_riding_5|knows_athletics_3|knows_ironflesh_3|knows_horse_archery_3|knows_power_draw_3,khergit_face_young_1, khergit_face_old_2],
...
#Companions
  ...
  ["npc17","Sohayil","Sohayil",tf_hero|tf_unmoveable_in_party_window, 0, reserved,  fac_commoners,[itm_mamluke_mail,itm_nomad_boots,itm_shahi,itm_bardiche,itm_warhorse],
   str_14|agi_9|int_13|cha_6|level(1),wp(110),knows_warrior_npc|
   knows_power_strike_2|knows_riding_2|knows_athletics_2|knows_trainer_2|knows_first_aid_1|knows_surgery_1|knows_engineer_2|knows_tracking_2,
   0x000000003f00458705c476dbdb61c7df00000000001db8f80000000000000000],
  ["npc18","Alvrad IV","Alvrad",tf_hero|tf_unmoveable_in_party_window, 0, reserved,  fac_commoners,[itm_black_armor,itm_black_greaves,itm_black_helmet,itm_bardiche,itm_courser],
   str_14|agi_9|int_13|cha_6|level(1),wp(110),knows_warrior_npc|
   knows_weapon_master_2|knows_power_strike_2|knows_athletics_2|knows_first_aid_3|knows_surgery_3|knows_engineer_1,
   0x000000019200221146db92296351b92500000000001eb69a0000000000000000],
  ["npc19","Kensi II","Kensi",tf_hero|tf_unmoveable_in_party_window, 0, reserved,  fac_commoners,[itm_strange_armor,itm_strange_boots,itm_strange_helmet,itm_strange_sword,itm_strange_great_sword,itm_strange_short_sword,itm_warhorse],
   str_10|agi_10|int_9|cha_13|level(1),wp(110),knows_warrior_npc|
   knows_weapon_master_2|knows_shield_3|knows_power_throw_3|knows_tactics_2|knows_leadership_3,
   0x000000002a0025c4495dadb6ef70482d00000000001db6f00000000000000000],
  ["npc20","Katherion","Katherion",tf_female|tf_hero|tf_unmoveable_in_party_window, 0, reserved,  fac_commoners,[itm_leather_jerkin,itm_nomad_boots, itm_byzantion_helmet_a, itm_sarranid_two_handed_mace_1],
   str_10|agi_13|int_9|cha_10|level(1),wp(110),knows_warrior_npc|
   knows_riding_2|knows_ironflesh_3|knows_first_aid_1|knows_surgery_5|knows_wound_treatment_5|knows_trainer_5|knows_first_aid_5,
   0x0000000000002003585b7135546db6d500000000001d36da0000000000000000],
  ["npc21","Nabeeleon","Nabeeleon",tf_hero|tf_unmoveable_in_party_window, 0, reserved,  fac_commoners,[itm_nomad_boots,itm_rabati,itm_sword_medieval_a,itm_khergit_sword_two_handed_a],
   str_6|agi_13|int_13|cha_6|level(1),wp(110),knows_merchant_npc|
   knows_weapon_master_2|knows_power_strike_2|knows_riding_2|knows_athletics_5|knows_power_throw_2|knows_first_aid_1|knows_surgery_1|knows_tactics_2|knows_leadership_2,
   0x000000003f0041534ada6db79b45b6db00000000001d2ac10000000000000000],
  ["npc22","Keltcher","Keltcher",tf_hero|tf_unmoveable_in_party_window, 0, reserved,  fac_commoners,[itm_leather_jerkin,itm_nomad_boots, itm_magyar_helmet_a,itm_strange_great_sword],
   str_10|agi_9|int_13|cha_10|level(1),wp(110),knows_warrior_npc|
   knows_weapon_master_2|knows_power_strike_2|knows_riding_2|knows_athletics_2|knows_power_throw_2|knows_first_aid_1|knows_surgery_1|knows_tactics_2|knows_leadership_2,
   0x000000001300015424db6db79bb1b72500000000001db6d10000000000000000],
  ["npc23","Shan Eh Li","Ehli",tf_female|tf_hero|tf_unmoveable_in_party_window, 0, reserved,  fac_commoners,[itm_leather_jerkin,itm_nomad_boots, itm_sipahi_helmet_a, itm_hafted_blade_b,itm_tab_shield_round_b],
   str_10|agi_13|int_9|cha_10|level(1),wp(110),knows_warrior_npc|
   knows_weapon_master_2|knows_power_strike_2|knows_riding_2|knows_athletics_2|knows_power_throw_2|knows_first_aid_1|knows_surgery_1|knows_tactics_2|knows_leadership_2,
   0x000000003f0010040bfb4e7028ce7fb300000000001cbb170000000000000000],
  ["npc24","Dastan","Dastan",tf_hero|tf_unmoveable_in_party_window, 0, reserved,  fac_commoners,[itm_leather_jerkin,itm_nomad_boots, itm_sledgehammer],
   str_14|agi_9|int_6|cha_13|level(1),wp(110),knows_merchant_npc|
   knows_weapon_master_2|knows_power_strike_2|knows_riding_2|knows_athletics_2|knows_power_throw_2|knows_first_aid_1|knows_surgery_1|knows_tactics_2|knows_leadership_2,
   0x000000000b0005c224d48d356ec8609700000000001db3210000000000000000],
  ["npc25","Nyi","Nyi",tf_female|tf_hero|tf_unmoveable_in_party_window, 0, reserved,  fac_commoners,[itm_black_armor,itm_black_greaves,itm_black_helmet,itm_khergit_sword_two_handed_a,itm_khergit_sword_two_handed_b,itm_war_bow,itm_arrows,itm_courser],
   str_10|agi_13|int_9|cha_10|level(1),wp(110),knows_warrior_npc|
   knows_weapon_master_2|knows_power_strike_2|knows_riding_2|knows_athletics_2|knows_power_throw_2|knows_first_aid_1|knows_surgery_1|knows_tactics_2|knows_leadership_2,
   0x000000003f00300636396db6346db6db00000000001db6db0000000000000000],
  ["npc26","Tsanya","Tsanya",tf_hero|tf_unmoveable_in_party_window, 0, reserved,  fac_commoners,[itm_mamluke_mail,itm_nomad_boots,itm_shahi,itm_bardiche,itm_sarranid_two_handed_mace_1],
   str_14|agi_9|int_13|cha_6|level(1),wp(110),knows_warrior_npc|
   knows_power_strike_2|knows_riding_2|knows_athletics_2|knows_trainer_2|knows_first_aid_1|knows_surgery_1|knows_engineer_2|knows_tracking_2,
   0x000000003f007589368e6db79b6db6b600000000001db6db0000000000000000],  
...
#governers olgrel rasevas                                                                        Horse          Bodywear                Footwear_in                     Footwear_out                    Armor                       Weapon                  Shield                  Headwaer
  ...
  ["kingdom_7_lord",  "Hegemon Alskodros Megas",  "Alskodros",  tf_hero, 0,reserved,  fac_kingdom_7,[itm_warhorse_sarranid,     itm_plate_armor,          itm_plate_boots,       itm_sarranid_mail_coif,  itm_mail_mittens,      itm_sarranid_cavalry_sword,    itm_tab_shield_small_round_c],         knight_attrib_4,wp(220),knight_skills_5|knows_trainer_10, 0x000000000d00100f6dcb6db6d36c171b00000000001cb6db0000000000000000, rhodok_face_old_2],
  ["kingdom_8_lord",  "Kurge Kushigtun",  "Kurge",  tf_hero, 0,reserved,  fac_kingdom_8,[itm_hunter,     itm_cuir_bouilli,          itm_plate_boots,       itm_sarranid_mail_coif,  itm_mail_mittens,      itm_flintlock_pistol,      itm_sarranid_cavalry_sword,    itm_tab_shield_small_round_c],         knight_attrib_4,wp(220),knight_skills_5|knows_trainer_10, 0x000000000d00100f6dcb6db6d36c171b00000000001cb6db0000000000000000, rhodok_face_old_2],
...
#khergit civilian clothes: itm_leather_vest, itm_nomad_vest, itm_nomad_robe, itm_lamellar_vest,itm_tribal_warrior_outfit
  ...
  ["knight_7_1", "Xoba Clayotus", "Clayotus", tf_hero, 0, reserved,  fac_kingdom_7, [itm_warhorse_sarranid,     itm_plate_armor,          itm_sarranid_boots_c,    itm_mail_boots,    itm_sarranid_warrior_cap, itm_leather_gloves,    itm_heavy_lance, itm_sarranid_cavalry_sword,   itm_tab_shield_small_round_c],     knight_attrib_1,wp(130),knight_skills_1|knows_trainer_3, 0x00000000600c2084486195383349eae500000000001d16a30000000000000000, rhodok_face_middle_2],
  ["knight_7_2", "Xoba Leyon", "Leyon", tf_hero, 0, reserved,  fac_kingdom_7, [itm_warhorse_sarranid,     itm_plate_armor,    itm_mail_boots,    itm_sarranid_warrior_cap, itm_leather_gloves,   itm_lance,   itm_military_pick,  itm_sword_two_handed_a,   itm_tab_shield_small_round_c],     knight_attrib_2,wp(160),knight_skills_2|knows_trainer_4, 0x00000001380825d444cb68b92b8d3b1d00000000001dd71e0000000000000000, rhodok_face_old_2],
  ["knight_7_3", "Xoba Hephae", "Hephae", tf_hero, 0, reserved,  fac_kingdom_7, [itm_warhorse_sarranid,     itm_plate_armor,       itm_nomad_boots,      itm_sarranid_warrior_cap,  itm_shortened_military_scythe, itm_lamellar_gauntlets,  itm_tab_shield_small_round_c],    knight_attrib_3,wp(190),knight_skills_3, 0x000000002208428579723147247ad4e500000000001f14d40000000000000000, rhodok_face_older_2],
  ["knight_7_4", "Xoba Parmeno", "Parmeno", tf_hero, 0, reserved,  fac_kingdom_7, [itm_warhorse_sarranid,     itm_plate_armor,            itm_sarranid_boots_c,          itm_sarranid_mail_coif,  itm_sarranid_cavalry_sword, itm_lamellar_gauntlets, itm_lance,   itm_tab_shield_small_round_c],    knight_attrib_4,wp(220),knight_skills_4, 0x00000009bf084285050caa7d285be51a00000000001d11010000000000000000, rhodok_face_older_2],
  ["knight_7_5", "Xoba Philot", "Philot", tf_hero, 0, reserved,  fac_kingdom_7, [itm_warhorse_sarranid,     itm_plate_armor,       itm_sarranid_boots_c,    itm_sarranid_veiled_helmet,  itm_shortened_military_scythe,  itm_tab_shield_small_round_c], knight_attrib_5,wp(250),knight_skills_5, 0x000000002a084003330175aae175da9c00000000001e02150000000000000000, rhodok_face_older_2],
  ["knight_7_6", "Xoba Craterus", "Craterus", tf_hero, 0, reserved,  fac_kingdom_7, [itm_warhorse_sarranid,     itm_plate_armor,            itm_sarranid_boots_c,      itm_splinted_greaves,    itm_sarranid_helmet1, itm_lance,      itm_sarranid_cavalry_sword,   itm_tab_shield_small_round_c],    knight_attrib_1,wp(130),knight_skills_1, 0x00000001830043834733294c89b128e200000000001259510000000000000000, rhodok_face_middle_2],
  ["knight_7_7", "Xoba Antigonus", "Antigonus", tf_hero, 0, reserved,  fac_kingdom_7, [itm_warhorse_sarranid,     itm_plate_armor,          itm_sarranid_boots_c,          itm_sarranid_mail_coif,       itm_sarranid_cavalry_sword,  itm_lamellar_gauntlets,  itm_tab_shield_small_round_c],     knight_attrib_2,wp(160),knight_skills_2, 0x0000000cbf10434020504bbbda9135d500000000001f62380000000000000000, rhodok_face_old_2],

  ["knight_8_1", "Kurtuz", "Kurtuz", tf_hero, 0, reserved,  fac_kingdom_8, [itm_hunter,     itm_cuir_bouilli,       itm_cartridges,          itm_sarranid_boots_c,    itm_mail_boots,    itm_sarranid_warrior_cap, itm_leather_gloves,    itm_flintlock_pistol,  itm_heavy_lance, itm_sarranid_cavalry_sword,   itm_tab_shield_small_round_c],     knight_attrib_1,wp(130),knight_skills_1|knows_trainer_3, 0x00000000600c2084486195383349eae500000000001d16a30000000000000000, rhodok_face_middle_2],
  ["knight_8_2", "Kulumbuz", "Kulumbuz", tf_hero, 0, reserved,  fac_kingdom_8, [itm_hunter,     itm_cuir_bouilli,       itm_cartridges,    itm_mail_boots,    itm_sarranid_warrior_cap, itm_leather_gloves,   itm_lance,   itm_flintlock_pistol,  itm_sword_two_handed_a,   itm_tab_shield_small_round_c],     knight_attrib_2,wp(160),knight_skills_2|knows_trainer_4, 0x00000001380825d444cb68b92b8d3b1d00000000001dd71e0000000000000000, rhodok_face_old_2],
  ["knight_8_3", "Kumerigu", "Kumerigu", tf_hero, 0, reserved,  fac_kingdom_8, [itm_hunter,     itm_cuir_bouilli,       itm_cartridges,       itm_nomad_boots,      itm_sarranid_warrior_cap,  itm_flintlock_pistol,  itm_shortened_military_scythe, itm_lamellar_gauntlets,  itm_tab_shield_small_round_c],    knight_attrib_3,wp(190),knight_skills_3, 0x000000002208428579723147247ad4e500000000001f14d40000000000000000, rhodok_face_older_2],
  ["knight_8_4", "Kugellan", "Kugellan", tf_hero, 0, reserved,  fac_kingdom_8, [itm_hunter,     itm_cuir_bouilli,       itm_cartridges,            itm_sarranid_boots_c,          itm_sarranid_mail_coif,  itm_flintlock_pistol,  itm_sarranid_cavalry_sword, itm_lamellar_gauntlets, itm_lance,   itm_tab_shield_small_round_c],    knight_attrib_4,wp(220),knight_skills_4, 0x00000009bf084285050caa7d285be51a00000000001d11010000000000000000, rhodok_face_older_2],
  ["knight_8_5", "Kuzarro", "Kuzzaro", tf_hero, 0, reserved,  fac_kingdom_8, [itm_hunter,     itm_cuir_bouilli,       itm_cartridges,       itm_sarranid_boots_c,    itm_sarranid_veiled_helmet,  itm_flintlock_pistol,  itm_shortened_military_scythe,  itm_tab_shield_small_round_c], knight_attrib_5,wp(250),knight_skills_5, 0x000000002a084003330175aae175da9c00000000001e02150000000000000000, rhodok_face_older_2],
  ["knight_8_6", "Juhn Smuth", "Juhn", tf_hero, 0, reserved,  fac_kingdom_8, [itm_hunter,     itm_cuir_bouilli,       itm_cartridges,            itm_splinted_greaves,    itm_sarranid_helmet1, itm_flintlock_pistol,      itm_sarranid_cavalry_sword,   itm_tab_shield_small_round_c],    knight_attrib_1,wp(130),knight_skills_1, 0x00000001830043834733294c89b128e200000000001259510000000000000000, rhodok_face_middle_2],
...
upgrade(troops,"haradian_recruit","haradian_footman")

upgrade2(troops,"haradian_footman","haradian_veteran_footman","haradian_skirmisher")
upgrade2(troops,"haradian_veteran_footman","haradian_horseman","haradian_infantry")
upgrade(troops,"haradian_infantry","haradian_guard")
upgrade(troops,"haradian_guard","haradian_paladin")

upgrade(troops,"haradian_skirmisher","haradian_archer")
upgrade(troops,"haradian_archer","haradian_master_archer")

upgrade(troops,"haradian_horseman","haradian_mamluke")
## haradianwomen
upgrade(troops,"haradian_surviver","safe_haradian")
upgrade(troops,"safe_haradian","healthy_haradian")
upgrade(troops,"healthy_haradian","haradian_horsewoman")
upgrade(troops,"haradian_horsewoman","haradian_at_arms")
upgrade2(troops,"haradian_at_arms","haradian_judge","haradian_chaser")
