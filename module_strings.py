...
#npc26 =  Tsan
  ...
  ("npc17_intro", "Hello, friend, would you care to join me for some Tea?"),
  ("npc18_intro", "You look like you have something to say, be out with it."),
  ("npc19_intro", "19Hello, friend, would you care to join me for some Tea?"),
  ("npc20_intro", "I need to quit this... but here is to finding ourselves anew!  Hopefully..."),
  ("npc21_intro", "Where i come from a cup of Tea is shared among friends and strangers."),
  ("npc22_intro", "22Hello, friend, would you care to join me for some Tea?"),
  ("npc23_intro", "23Hello, friend, would you care to join me for some Tea?"),
  ("npc24_intro", "I was Following Magical Pixies that told me to talk to you."),
  ("npc25_intro", "Shall i let you in on a little secret?"),
  ("npc26_intro", "A man i recently met said that a true friend can be found with the leaves of tea.  do you agree?"),
  ...
  ("npc17_intro_response_1", "Possibly?"),
  ("npc18_intro_response_1", "Are you asking me a question?"),
  ("npc19_intro_response_1", "19Do you want something?"),
  ("npc20_intro_response_1", "what do you want?"),
  ("npc21_intro_response_1", "If you don't mind i'd prefer a flagon of mead."),
  ("npc22_intro_response_1", "22Do you want something?"),
  ("npc23_intro_response_1", "23Do you want something?"),
  ("npc24_intro_response_1", "You are a humorous fellow"),
  ("npc25_intro_response_1", "... That armor..."),
  ("npc26_intro_response_1", "Your friend seems interesting."),
  ...
  ("npc17_intro_response_2", "I do not trust a man who chooses not to drink."),
  ("npc18_intro_response_2", "I have nothing to say to you."),
  ("npc19_intro_response_2", "19I do not trust a man who chooses not to drink."),
  ("npc20_intro_response_2", "I've already found myself."),
  ("npc21_intro_response_2", "Take your tea back to the fields."),
  ("npc22_intro_response_2", "22I do not trust a man who chooses not to drink."),
  ("npc23_intro_response_2", "23I do not trust a man who chooses not to drink."),
  ("npc24_intro_response_2", "wait, what?."),
  ("npc25_intro_response_2", "No."),
  ("npc26_intro_response_2", "Then I guess I should go look for your 'Friend' instead."),
...
#backstory intro
  ...
  ("npc17_backstory_a", "Let me tell you a story, {sir/madame}.  Last week I was setting out to do my regularly schedules liberation of slaves, but something unexpected happened."),
  ("npc18_backstory_a", "I was trained at the Sargoth Military Achademy, I am a skilled fighter"),
  ("npc19_backstory_a", "19Let me tell you a story, {sir/madame}.  One day an Engineer from Shariz that faced exile for upholding justice, and a Haradian blood slave born in the country side west of Praven had moved out of Sargoth with their child in search of more tolorant and enlightened lands..."),
  ("npc20_backstory_a", "Between men, this, and fighting.  My life all just been a waste."),
  ("npc21_backstory_a", "Let me tell you a story, {sir/madame}."),
  ("npc22_backstory_a", "22Let me tell you a story, {sir/madame}.  One day an Engineer from Shariz that faced exile for upholding justice, and a Haradian blood slave born in the country side west of Praven had moved out of Sargoth with their child in search of more tolorant and enlightened lands..."),
  ("npc23_backstory_a", "23Let me tell you a story, {sir/madame}.  One day an Engineer from Shariz that faced exile for upholding justice, and a Haradian blood slave born in the country side west of Praven had moved out of Sargoth with their child in search of more tolorant and enlightened lands..."),
  ("npc24_backstory_a", "I once was a defender of my village, a small town, but gradually i found myself less and less wanting to pick up a sword."),
  ("npc25_backstory_a", "Right...  I was a member of the Order of the Light.  We wore black to signify that we love the light and would dare not show pride to the sun."),
  ("npc26_backstory_a", "I was born in the Island Kingdom of Haradia, King Rolf and his entire House of Rolfs were Laid to waste by the Macon."),
...
#backstory main body
  ...
  ("npc17_backstory_b", "Before i could liberate the slaves something grabbed my foot you see, out of the cold earth, a human hands just popped out, so naturally i cut it off and turned around to see an army of the dead."),
  ("npc18_backstory_b", "I had to unfortunately part ways with my regiment after using my creator given free thought."),
  ("npc19_backstory_b", "19They were slaughtered, not by bandits, but by Vaegirs who decided to raid a 'Nord Caravan'... from that day, their surviving son travelled with Looters, Raiders, Bandits, and Free Brothers, until he realized he had become a tool of what he hated most... Injustice"),
  ("npc20_backstory_b", "I started my waste when I was young, after the first time I was taken by men, I felt worthless, and I made pleanty of poor choices, this is when I turned to drinking.  Naturally drinking simply made the problem worse, so i turned to fighting."),
  ("npc21_backstory_b", "As a Sarranid upholding justice is honor, and honor is life.  Those without honor are those without life, the looters, pillagers, brigands of this land are many, and sometimes the Nobles are the same"),
  ("npc22_backstory_b", "22They were slaughtered, not by bandits, but by Vaegirs who decided to raid a 'Nord Caravan'... from that day, their surviving son travelled with Looters, Raiders, Bandits, and Free Brothers, until he realized he had become a tool of what he hated most... Injustice"),
  ("npc23_backstory_b", "23They were slaughtered, not by bandits, but by Vaegirs who decided to raid a 'Nord Caravan'... from that day, their surviving son travelled with Looters, Raiders, Bandits, and Free Brothers, until he realized he had become a tool of what he hated most... Injustice"),
  ("npc24_backstory_b", "Soon I could no longer trust myself to maintain in that village and hold a sword, i decided to leave the sword... then my village decided to leave me."),
  ("npc25_backstory_b", "How I got to Join the order is simple.  I am a Haradian, our lands were conquered shortly after prince Rolf of the Rolf dynasty went adventuring.  Between the Macon and the Calradians our men were put to work, while... lets just say... Men can be... cruel.  The order found us after our escape from slavery, the fed us, they gave us cloths, we already knew how to fight.  While the methods of the order do not bother me, but I do find it frivolous..."),
  ("npc26_backstory_b", "We packed up and sailed for the north eastern lands of Calradia where Prince Rolf is said to be, and when we arived on the coast near Yalen, we were all enslaved, women and girls for pleasure, men and boys for labor... I was 10."),
...
#backstory recruit pitch
  ...
  ("npc17_backstory_c", "so i swiftly liberated the slaves with help from the undead and quickly fled...  Now i am at a complete loss!  Take down establishment? Destroy the undead?"),
  ("npc18_backstory_c", "You will need someone like me."),
  ("npc19_backstory_c", "19What woke me up was seeing a greater evil...  with my own eyes, Undeath, Black knights, and truly great oppressors!  If one day a {Brother/Sister} would raise their axe to join mine, we could take spread accross this land, bringing peace, and make peace with the other parts of this continent that Calradia only makes up the small northeaster corner of...  what a dream, right?"),
  ("npc20_backstory_c", "When a woman is taken, no one raises a voice.  When a mans essence has been smashed by my mace, villages kick me out."),
  ("npc21_backstory_c", "Injustice is injustice no matter the host."),
  ("npc22_backstory_c", "22What woke me up was seeing a greater evil...  with my own eyes, Undeath, Black knights, and truly great oppressors!  If one day a {Brother/Sister} would raise their axe to join mine, we could take spread accross this land, bringing peace, and make peace with the other parts of this continent that Calradia only makes up the small northeaster corner of...  what a dream, right?"),
  ("npc23_backstory_c", "23What woke me up was seeing a greater evil...  with my own eyes, Undeath, Black knights, and truly great oppressors!  If one day a {Brother/Sister} would raise their axe to join mine, we could take spread accross this land, bringing peace, and make peace with the other parts of this continent that Calradia only makes up the small northeaster corner of...  what a dream, right?"),
  ("npc24_backstory_c", "I Like Turtles."),
  ("npc25_backstory_c", "I doubt you have a good impression of the Order...  In fact, when I saw just how Fanatic they had become, I knew I had to leave, I persuaded one to escape with me, but I do not trust him alone, so I abandoned him...  Great fighter, Scarey person"),
  ("npc26_backstory_c", "last week I was sold to a noble in Shariz...  During transport in the night, we were attacked, not by men of any kingdom, but attacked by a horde of the dead...  That is when a man named Sohayil freed me, he hates slavery and knows we need every man and woman to fight this scourge of undeath."),
...
### use these if there is a short period of time between the last meeting 
  ...
  ("npc17_backstory_later", "I have been doing what i can by myself."),
  ("npc18_backstory_later", "Are you ready to make a smart choice?"),
  ("npc19_backstory_later", "19I have been doing what i can by myself."),  
  ("npc20_backstory_later", "I still breath."),  
  ("npc21_backstory_later", "Without funds, upholding justice is quite foolhardy..."),  
  ("npc22_backstory_later", "22I have been doing what i can by myself."),  
  ("npc23_backstory_later", "23I have been doing what i can by myself."),  
  ("npc24_backstory_later", "Huehuehuehue"),  
  ("npc25_backstory_later", "Is the goal of life to continue living?  Is light a lie? Is darkness the truth?  I simply do not know..."),   
  ("npc26_backstory_later", "I cannot free them by myself..."),   
  ...
  ("npc17_backstory_response_1", "Join me."),
  ("npc18_backstory_response_1", "I Do."),
  ("npc19_backstory_response_1", "19I like Justice, want to hit things with your axe?"),
  ("npc20_backstory_response_1", "Mace? can you fight?"),
  ("npc21_backstory_response_1", "I like Justice, want to hit things?"),
  ("npc22_backstory_response_1", "22I like Justice, want to hit things with your axe?"),
  ("npc23_backstory_response_1", "23I like Justice, want to hit things with your axe?"),
  ("npc24_backstory_response_1", "Would you mind picking up the sword again?"),
  ("npc25_backstory_response_1", "Come with me, I could use your skills, and you could use friends."),
  ("npc26_backstory_response_1", "The scourge will not take this lands!"),
  ...
  ("npc17_backstory_response_2", "I should call the guards and tell them about the murderer in the tavern."),
  ("npc18_backstory_response_2", "You are drunk, go to bed."),
  ("npc19_backstory_response_2", "19Stop watching those plays."),
  ("npc20_backstory_response_2", "Yea, No."),
  ("npc21_backstory_response_2", "Be a man."),
  ("npc22_backstory_response_2", "22Stop watching those plays."),
  ("npc23_backstory_response_2", "23Stop watching those plays."),
  ("npc24_backstory_response_2", "*Silence* (responding would be promoting)"),
  ("npc25_backstory_response_2", "good story."),
  ("npc26_backstory_response_2", "Hah, i do not fear the dead, or the living."),
  ...
  ("npc17_signup", "So, the hordes of undead travel in packs of hundreds, say the word, I'm ready."),
  ("npc18_signup", "I am ready for this.  Are you ready for this?"),
  ("npc19_signup", "19I am as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and be as mysterious as the dark side of the moon."),
  ("npc20_signup", "Indeed I cans, I like to use a mace because I like the fight, every bone crushing hit makes me feel alive again!"),
  ("npc21_signup", "I am as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and be as mysterious as the dark side of the moon."),
  ("npc22_signup", "22I am as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and be as mysterious as the dark side of the moon."),
  ("npc23_signup", "23I am as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and be as mysterious as the dark side of the moon."),
  ("npc24_signup", "I would pick up a weapon for you."),
  ("npc25_signup", "I have nothing else to do, I only know how to kill, just like the Undead.  Can you help me find a difference?"),
  ("npc26_signup", "Let us find my the warrior Sohayil, after the commotion he gave me this armor, and many others other armor as well, but the horde found us soon again and we parted ways in the panic, but i am sure he made it out alive."),
  ...
  ("npc17_signup_2", "I have my Beard, My Axe, and I am not naked, lets go."),
  ("npc18_signup_2", "I will need your band roster and organization charts."),
  ("npc19_signup_2", "19Lets Roll."),
  ("npc20_signup_2", "You must find and liberate Haradian slaves.  Be warned, if I join you, and someone touches me, I will break them."),
  ("npc21_signup_2", "Honor guide me."),
  ("npc22_signup_2", "22Lets Roll."),
  ("npc23_signup_2", "23Lets Roll."),
  ("npc24_signup_2", "Oh Thank you!"),
  ("npc25_signup_2", "May the dead stay dead!"),
  ("npc26_signup_2", "Let us also find some of my sisters and brothers, the Haradians, with a bit of food and rest they will grow to be some of your greatest comrades."),
  ...
  ("npc17_signup_response_1", "Glad to have you in the Band."),
  ("npc18_signup_response_1", "I am"),
  ("npc19_signup_response_1", "19Excellent."),
  ("npc20_signup_response_1", "Great, although retribution never helps us find peace, i'd love to have your mace join us."),
  ("npc21_signup_response_1", "Nice."),
  ("npc22_signup_response_1", "22Excellent."),
  ("npc23_signup_response_1", "23Excellent."),
  ("npc24_signup_response_1", "Alright, I will see you in rank."),
  ("npc25_signup_response_1", "We will never know unless we look."),
  ("npc26_signup_response_1", "Excellent."),
...
#11
  ...
  ("npc17_signup_response_2", "I really think i should call the guards on you."),
  ("npc18_signup_response_2", "Here you go."),
  ("npc19_signup_response_2", "19Learn To Be A Man."),
  ("npc20_signup_response_2", "*swiftly turn and run*"),
  ("npc21_signup_response_2", "Eh, I have no care for your honor."),
  ("npc22_signup_response_2", "22Learn To Be A Man."),
  ("npc23_signup_response_2", "23Learn To Be A Man."),
  ("npc24_signup_response_2", "Be A Man."),
  ("npc25_signup_response_2", "A lost person should find their way before committing to anothers way."),
  ("npc26_signup_response_2", "Slaves should serve, not enjoy taverns."),
  ...
  ("npc21_payment_response", "{!}."),
  ("npc22_payment_response", "{!}."),
  ("npc23_payment_response", "{!}."),
  ("npc24_payment_response", "{!}."),
  ("npc25_payment_response", "{!}."),
  ("npc26_payment_response", "{!}."),
  ...
  ("npc17_morality_speech", "STOP THAT!  Be as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and as mysterious as the dark side of the moon."),
  ("npc18_morality_speech", "STOP THAT!  Be as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and as mysterious as the dark side of the moon."),
  ("npc19_morality_speech", "STOP THAT!  Be as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and as mysterious as the dark side of the moon."),
  ("npc20_morality_speech", "STOP THAT!  Be as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and as mysterious as the dark side of the moon."),
  ("npc21_morality_speech", "STOP THAT!  Be as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and as mysterious as the dark side of the moon."),
  ("npc22_morality_speech", "STOP THAT!  Be as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and as mysterious as the dark side of the moon."),
  ("npc23_morality_speech", "STOP THAT!  Be as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and as mysterious as the dark side of the moon."),
  ("npc24_morality_speech", "STOP THAT!  Be as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and as mysterious as the dark side of the moon."),
  ("npc25_morality_speech", "STOP THAT!  Be as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and as mysterious as the dark side of the moon."),
  ("npc26_morality_speech", "STOP THAT!  Be as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and as mysterious as the dark side of the moon."),
  ...
  ("npc17_2ary_morality_speech", "STOP THAT!  Be as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and as mysterious as the dark side of the moon."),
  ("npc18_2ary_morality_speech", "STOP THAT!  Be as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and as mysterious as the dark side of the moon."),
  ("npc19_2ary_morality_speech", "STOP THAT!  Be as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and as mysterious as the dark side of the moon."),
  ("npc20_2ary_morality_speech", "STOP THAT!  Be as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and as mysterious as the dark side of the moon."),
  ("npc21_2ary_morality_speech", "STOP THAT!  Be as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and as mysterious as the dark side of the moon."),
  ("npc22_2ary_morality_speech", "STOP THAT!  Be as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and as mysterious as the dark side of the moon."),
  ("npc23_2ary_morality_speech", "STOP THAT!  Be as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and as mysterious as the dark side of the moon."),
  ("npc24_2ary_morality_speech", "STOP THAT!  Be as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and as mysterious as the dark side of the moon."),
  ("npc25_2ary_morality_speech", "STOP THAT!  Be as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and as mysterious as the dark side of the moon."),
  ("npc26_2ary_morality_speech", "STOP THAT!  Be as swift as a coursing river, with the strength of a great typhoon, and the might of a raging fire, and as mysterious as the dark side of the moon."),
  ...
  ("npc17_personalityclash_speech", "... nope..."),
  ("npc18_personalityclash_speech", "... nope..."),
  ("npc19_personalityclash_speech", "... nope..."),
  ("npc20_personalityclash_speech", "... nope..."),
  ("npc21_personalityclash_speech", "... nope..."),
  ("npc22_personalityclash_speech", "... nope..."),
  ("npc23_personalityclash_speech", "... nope..."),
  ("npc24_personalityclash_speech", "... nope..."),
  ("npc25_personalityclash_speech", "... nope..."),
  ("npc26_personalityclash_speech", "... nope..."),
  ...
  ("npc17_personalityclash_speech_b", "... nope... "),
  ("npc18_personalityclash_speech_b", "... nope... "),
  ("npc19_personalityclash_speech_b", "... nope... "),
  ("npc20_personalityclash_speech_b", "... nope... "),
  ("npc21_personalityclash_speech_b", "... nope... "),
  ("npc22_personalityclash_speech_b", "... nope... "),
  ("npc23_personalityclash_speech_b", "... nope... "),
  ("npc24_personalityclash_speech_b", "... nope... "),
  ("npc25_personalityclash_speech_b", "... nope... "),
  ("npc26_personalityclash_speech_b", "... nope... "),
...
### set off by behavior after victorious battle
  ...
  ("npc17_personalityclash2_speech", "... nope..."),
  ("npc18_personalityclash2_speech", "... nope..."),
  ("npc19_personalityclash2_speech", "... nope..."),
  ("npc20_personalityclash2_speech", "... nope..."),
  ("npc21_personalityclash2_speech", "... nope..."),
  ("npc22_personalityclash2_speech", "... nope..."),
  ("npc23_personalityclash2_speech", "... nope..."),
  ("npc24_personalityclash2_speech", "... nope..."),
  ("npc25_personalityclash2_speech", "... nope..."),
  ("npc26_personalityclash2_speech", "... nope..."),
  ...
  ("npc17_personalityclash2_speech_b", "... nope..."), #klethi - borcha
  ("npc18_personalityclash2_speech_b", "... nope..."), #klethi - borcha
  ("npc19_personalityclash2_speech_b", "... nope..."), #klethi - borcha
  ("npc20_personalityclash2_speech_b", "... nope..."), #klethi - borcha
  ("npc21_personalityclash2_speech_b", "... nope..."), #klethi - borcha
  ("npc22_personalityclash2_speech_b", "... nope..."), #klethi - borcha
  ("npc23_personalityclash2_speech_b", "... nope..."), #klethi - borcha
  ("npc24_personalityclash2_speech_b", "... nope..."), #klethi - borcha
  ("npc25_personalityclash2_speech_b", "... nope..."), #klethi - borcha
  ("npc26_personalityclash2_speech_b", "... nope..."), #klethi - borcha
  ...
  ("npc17_personalitymatch_speech", "I am glad {s11} is in the band."),
  ("npc18_personalitymatch_speech", "This {s11}.  I feel safe knowing that he is in your army."),
  ("npc19_personalitymatch_speech", "{s11}."),
  ("npc20_personalitymatch_speech", "{s11}."),
  ("npc21_personalitymatch_speech", "{s11}."),
  ("npc22_personalitymatch_speech", "{s11}."),
  ("npc23_personalitymatch_speech", "{s11}."),
  ("npc24_personalitymatch_speech", "{s11}."),
  ("npc25_personalitymatch_speech", "{s11}, they have always looked out for me, I do not know why I cannot trust him, but I am glad to see him in your company."),
  ("npc26_personalitymatch_speech", "I am saddened about {s11}s loss of wife, he is an excellent friend and a true comrade"),
  ...
  ("npc17_personalitymatch_speech_b", "This {s11} Guy.... He is as swift as a coursing river, he has the strength of a great typhoon, he has the might of a raging fire, and i think he's a bit off... its confusing really"),
  ("npc18_personalitymatch_speech_b", "This {s11} Guy.... He is as swift as a coursing river, he has the strength of a great typhoon, he has the might of a raging fire, and i think he's a bit off... its confusing really"),
  ("npc19_personalitymatch_speech_b", "This {s11} Guy.... He is as swift as a coursing river, he has the strength of a great typhoon, he has the might of a raging fire, and i think he's a bit off... its confusing really"),
  ("npc20_personalitymatch_speech_b", "This {s11} Guy.... He is as swift as a coursing river, he has the strength of a great typhoon, he has the might of a raging fire, and i think he's a bit off... its confusing really"),
  ("npc21_personalitymatch_speech_b", "This {s11} Guy.... He is as swift as a coursing river, he has the strength of a great typhoon, he has the might of a raging fire, and i think he's a bit off... its confusing really"),
  ("npc22_personalitymatch_speech_b", "This {s11} Guy.... He is as swift as a coursing river, he has the strength of a great typhoon, he has the might of a raging fire, and i think he's a bit off... its confusing really"),
  ("npc23_personalitymatch_speech_b", "This {s11} Guy.... He is as swift as a coursing river, he has the strength of a great typhoon, he has the might of a raging fire, and i think he's a bit off... its confusing really"),
  ("npc24_personalitymatch_speech_b", "This {s11} Guy.... He is as swift as a coursing river, he has the strength of a great typhoon, he has the might of a raging fire, and i think he's a bit off... its confusing really"),
  ("npc25_personalitymatch_speech_b", "This {s11} Guy.... He is as swift as a coursing river, he has the strength of a great typhoon, he has the might of a raging fire, and i think he's a bit off... its confusing really"),
  ("npc26_personalitymatch_speech_b", "Perhaps we could find him a sword sister, or convince one of those Dark Knight ladies!"),
  ...
  ("npc17_retirement_speech", "As the wise Crayon Shin Chan once said 'To be a man you must have honor, honor and a penis.'  I will go forget my dream now."),
  ("npc18_retirement_speech", "As the wise Crayon Shin Chan once said 'To be a man you must have honor, honor and a penis.'  I will go forget my dream now."),
  ("npc19_retirement_speech", "As the wise Crayon Shin Chan once said 'To be a man you must have honor, honor and a penis.'  I will go forget my dream now."),
  ("npc20_retirement_speech", "As the wise Crayon Shin Chan once said 'To be a man you must have honor, honor and a penis.'  I will go forget my dream now."),
  ("npc21_retirement_speech", "As the wise Crayon Shin Chan once said 'To be a man you must have honor, honor and a penis.'  I will go forget my dream now."),
  ("npc22_retirement_speech", "As the wise Crayon Shin Chan once said 'To be a man you must have honor, honor and a penis.'  I will go forget my dream now."),
  ("npc23_retirement_speech", "As the wise Crayon Shin Chan once said 'To be a man you must have honor, honor and a penis.'  I will go forget my dream now."),
  ("npc24_retirement_speech", "As the wise Crayon Shin Chan once said 'To be a man you must have honor, honor and a penis.'  I will go forget my dream now."),
  ("npc25_retirement_speech", "As the wise Crayon Shin Chan once said 'To be a man you must have honor, honor and a penis.'  I will go forget my dream now."),
  ("npc26_retirement_speech", "As the wise Crayon Shin Chan once said 'To be a man you must have honor, honor and a penis.'  I will go forget my dream now."),
  ...
  ("npc17_rehire_speech", "Hello Comrade, as the people from east of the mountains say 'Hao Zho Bu Jian'  do not worry, my axe is still sharp."),
  ("npc18_rehire_speech", "Hello Comrade, as the people from east of the mountains say 'Hao Zho Bu Jian'  do not worry, my axe is still sharp."),
  ("npc19_rehire_speech", "Hello Comrade, as the people from east of the mountains say 'Hao Zho Bu Jian'  do not worry, my axe is still sharp."),
  ("npc20_rehire_speech", "Hello Comrade, as the people from east of the mountains say 'Hao Zho Bu Jian'  do not worry, my axe is still sharp."),
  ("npc21_rehire_speech", "Hello Comrade, as the people from east of the mountains say 'Hao Zho Bu Jian'  do not worry, my axe is still sharp."),
  ("npc22_rehire_speech", "Hello Comrade, as the people from east of the mountains say 'Hao Zho Bu Jian'  do not worry, my axe is still sharp."),
  ("npc23_rehire_speech", "Hello Comrade, as the people from east of the mountains say 'Hao Zho Bu Jian'  do not worry, my axe is still sharp."),
  ("npc24_rehire_speech", "Hello Comrade, as the people from east of the mountains say 'Hao Zho Bu Jian'  do not worry, my axe is still sharp."),
  ("npc25_rehire_speech", "Hello Comrade, as the people from east of the mountains say 'Hao Zho Bu Jian'  do not worry, my axe is still sharp."),
  ("npc26_rehire_speech", "Hello Comrade, as the people from east of the mountains say 'Hao Zho Bu Jian'  do not worry, my axe is still sharp."),
...
#local color strings
  ...
  ("npc17_home_intro", "...The cool air..."),
  ("npc18_home_intro", "...The cool air..."),
  ("npc19_home_intro", "...The cool air..."),
  ("npc20_home_intro", "...The cool air..."),
  ("npc21_home_intro", "...The cool air..."),
  ("npc22_home_intro", "...The cool air..."),
  ("npc23_home_intro", "...The cool air..."),
  ("npc24_home_intro", "...The cool air..."),
  ("npc25_home_intro", "...The cool air..."),
  ("npc26_home_intro", "...The cool air..."),
...
#  ("npc13_home_description", "I had come up here with a small Swadian force, but they were caught by the Rhodoks in the woods and their horsemen cut down amid the trees. I fled and found shelter by the lake, in the arms of the comeliest cowherd you ever saw. She took me to a cave near the high pastures, and would bring me cheese and berries, and tell me the tale from the hills. They say the lake is a gateway to the underworld, and sometimes on the fringes you can the noxious fumes beneath bubbling up to the surface. Such rustics they are!"),
  ...
  ("npc17_home_description", "I remember riding my horse here as a child...  Little known, but many Sarranids are taught to respect and ride horses as kergits, they just have less public displays of reverance, or private displays for that matter."),
  ("npc18_home_description", "I remember riding my horse here as a child...  Little known, but many Sarranids are taught to respect and ride horses as kergits, they just have less public displays of reverance, or private displays for that matter."),
  ("npc19_home_description", "I remember riding my horse here as a child...  Little known, but many Sarranids are taught to respect and ride horses as kergits, they just have less public displays of reverance, or private displays for that matter."),
  ("npc20_home_description", "I remember riding my horse here as a child...  Little known, but many Sarranids are taught to respect and ride horses as kergits, they just have less public displays of reverance, or private displays for that matter."),
  ("npc21_home_description", "I remember riding my horse here as a child...  Little known, but many Sarranids are taught to respect and ride horses as kergits, they just have less public displays of reverance, or private displays for that matter."),
  ("npc22_home_description", "I remember riding my horse here as a child...  Little known, but many Sarranids are taught to respect and ride horses as kergits, they just have less public displays of reverance, or private displays for that matter."),
  ("npc23_home_description", "I remember riding my horse here as a child...  Little known, but many Sarranids are taught to respect and ride horses as kergits, they just have less public displays of reverance, or private displays for that matter."),
  ("npc24_home_description", "I remember riding my horse here as a child...  Little known, but many Sarranids are taught to respect and ride horses as kergits, they just have less public displays of reverance, or private displays for that matter."),
  ("npc25_home_description", "I remember riding my horse here as a child...  Little known, but many Sarranids are taught to respect and ride horses as kergits, they just have less public displays of reverance, or private displays for that matter."),
  ("npc26_home_description", "I remember riding my horse here as a child...  Little known, but many Sarranids are taught to respect and ride horses as kergits, they just have less public displays of reverance, or private displays for that matter."),
  ...
  ("npc17_home_description_2", "I my father told me to run, live and grow strong after my mother was stuck by an arrow, he then charged towards the massive army, with 2 other men, allowing the caravan and I to attempt to escape, I parted from the caravan and fled into the mountains that devide Swadia from the Nord Lands."),
  ("npc18_home_description_2", "I my father told me to run, live and grow strong after my mother was stuck by an arrow, he then charged towards the massive army, with 2 other men, allowing the caravan and I to attempt to escape, I parted from the caravan and fled into the mountains that devide Swadia from the Nord Lands."),
  ("npc19_home_description_2", "I my father told me to run, live and grow strong after my mother was stuck by an arrow, he then charged towards the massive army, with 2 other men, allowing the caravan and I to attempt to escape, I parted from the caravan and fled into the mountains that devide Swadia from the Nord Lands."),
  ("npc20_home_description_2", "I my father told me to run, live and grow strong after my mother was stuck by an arrow, he then charged towards the massive army, with 2 other men, allowing the caravan and I to attempt to escape, I parted from the caravan and fled into the mountains that devide Swadia from the Nord Lands."),
  ("npc21_home_description_2", "I my father told me to run, live and grow strong after my mother was stuck by an arrow, he then charged towards the massive army, with 2 other men, allowing the caravan and I to attempt to escape, I parted from the caravan and fled into the mountains that devide Swadia from the Nord Lands."),
  ("npc22_home_description_2", "I my father told me to run, live and grow strong after my mother was stuck by an arrow, he then charged towards the massive army, with 2 other men, allowing the caravan and I to attempt to escape, I parted from the caravan and fled into the mountains that devide Swadia from the Nord Lands."),
  ("npc23_home_description_2", "I my father told me to run, live and grow strong after my mother was stuck by an arrow, he then charged towards the massive army, with 2 other men, allowing the caravan and I to attempt to escape, I parted from the caravan and fled into the mountains that devide Swadia from the Nord Lands."),
  ("npc24_home_description_2", "I my father told me to run, live and grow strong after my mother was stuck by an arrow, he then charged towards the massive army, with 2 other men, allowing the caravan and I to attempt to escape, I parted from the caravan and fled into the mountains that devide Swadia from the Nord Lands."),
  ("npc25_home_description_2", "I my father told me to run, live and grow strong after my mother was stuck by an arrow, he then charged towards the massive army, with 2 other men, allowing the caravan and I to attempt to escape, I parted from the caravan and fled into the mountains that devide Swadia from the Nord Lands."),
  ("npc26_home_description_2", "I my father told me to run, live and grow strong after my mother was stuck by an arrow, he then charged towards the massive army, with 2 other men, allowing the caravan and I to attempt to escape, I parted from the caravan and fled into the mountains that devide Swadia from the Nord Lands."),
  ...
  ("npc17_home_recap", "I would love the crush the Vaegir, Swadian, and Sarranid houses, bring the nobels down to people, but we also have Undead, Black Knights, and Great oppressors to twart."),
  ("npc18_home_recap", "I would love the crush the Vaegir, Swadian, and Sarranid houses, bring the nobels down to people, but we also have Undead, Black Knights, and Great oppressors to twart."),
  ("npc19_home_recap", "I would love the crush the Vaegir, Swadian, and Sarranid houses, bring the nobels down to people, but we also have Undead, Black Knights, and Great oppressors to twart."),
  ("npc20_home_recap", "I would love the crush the Vaegir, Swadian, and Sarranid houses, bring the nobels down to people, but we also have Undead, Black Knights, and Great oppressors to twart."),
  ("npc21_home_recap", "I would love the crush the Vaegir, Swadian, and Sarranid houses, bring the nobels down to people, but we also have Undead, Black Knights, and Great oppressors to twart."),
  ("npc22_home_recap", "I would love the crush the Vaegir, Swadian, and Sarranid houses, bring the nobels down to people, but we also have Undead, Black Knights, and Great oppressors to twart."),
  ("npc23_home_recap", "I would love the crush the Vaegir, Swadian, and Sarranid houses, bring the nobels down to people, but we also have Undead, Black Knights, and Great oppressors to twart."),
  ("npc24_home_recap", "I would love the crush the Vaegir, Swadian, and Sarranid houses, bring the nobels down to people, but we also have Undead, Black Knights, and Great oppressors to twart."),
  ("npc25_home_recap", "I would love the crush the Vaegir, Swadian, and Sarranid houses, bring the nobels down to people, but we also have Undead, Black Knights, and Great oppressors to twart."),
  ("npc26_home_recap", "I would love the crush the Vaegir, Swadian, and Sarranid houses, bring the nobels down to people, but we also have Undead, Black Knights, and Great oppressors to twart."),
  ...
  ("npc17_honorific", "comrade"), #Sohayil
  ("npc18_honorific", "comrade"), #Sohayil
  ("npc19_honorific", "comrade"), #Sohayil
  ("npc20_honorific", "comrade"), #Sohayil
  ("npc21_honorific", "Doostan"), #Sohayil
  ("npc22_honorific", "comrade"), #Sohayil
  ("npc23_honorific", "comrade"), #Sohayil
  ("npc24_honorific", "comrade"), #Sohayil
  ("npc25_honorific", "commander"), #nyi
  ("npc26_honorific", "comrade"), #Sohayil
  ...
  ("npc17_kingsupport_1", "Comrade, If you want it, I will help you take it."), #Sohayil
  ("npc18_kingsupport_1", "Comrade, If you want it, I will help you take it."), #Sohayil
  ("npc19_kingsupport_1", "Comrade, If you want it, I will help you take it."), #Sohayil
  ("npc20_kingsupport_1", "Comrade, If you want it, I will help you take it."), #Sohayil
  ("npc21_kingsupport_1", "Comrade, If you want it, I will help you take it."), #Sohayil
  ("npc22_kingsupport_1", "Comrade, If you want it, I will help you take it."), #Sohayil
  ("npc23_kingsupport_1", "Comrade, If you want it, I will help you take it."), #Sohayil
  ("npc24_kingsupport_1", "Comrade, If you want it, I will help you take it."), #Sohayil
  ("npc25_kingsupport_1", "Comrade, If you want it, I will help you take it."), #Sohayil
  ("npc26_kingsupport_1", "Comrade, If you want it, I will help you take it."), #Sohayil
  ...
  ("npc17_kingsupport_2", "Comrade, I think if you can unite this land, you could bring justice to its lowly people, use your wealth to spread wealth, and most urgently crush the undead armies"), #Sohayil
  ("npc18_kingsupport_2", "18"), #Sohayil
  ("npc19_kingsupport_2", "19"),
  ("npc20_kingsupport_2", "20"),
  ("npc21_kingsupport_2", "Comrade, I think if you can unite this land, you can bring justice to its lowly people, use your wealth to spread wealth, and most urgently crush the undead armies"), #Sohayil
  ("npc22_kingsupport_2", "Comrade, I think if you can unite this land, you can bring justice to its lowly people, use your wealth to spread wealth, and most urgently crush the undead armies"), #Sohayil
  ("npc23_kingsupport_2", "Comrade, I think if you can unite this land, you can bring justice to its lowly people, use your wealth to spread wealth, and most urgently crush the undead armies"), #Sohayil
  ("npc24_kingsupport_2", "Comrade, I think if you can unite this land, you can bring justice to its lowly people, use your wealth to spread wealth, and most urgently crush the undead armies"), #Sohayil
  ("npc25_kingsupport_2", "I will follow you to the grave"), #Sohayil
  ("npc26_kingsupport_2", "Of course, comrade, I think if you can unite this land, you can bring justice to its lowly people, use your wealth to spread wealth, and most urgently crush the undead armies"), #Sohayil
  ...
  ("npc17_kingsupport_2a", "... continue..."), #klethi
  ("npc18_kingsupport_2a", "... continue..."), #klethi
  ("npc19_kingsupport_2a", "... continue..."), #klethi
  ("npc20_kingsupport_2a", "... continue..."), #klethi
  ("npc21_kingsupport_2a", "... continue..."), #klethi
  ("npc22_kingsupport_2a", "... continue..."), #klethi
  ("npc23_kingsupport_2a", "... continue..."), #klethi
  ("npc24_kingsupport_2a", "... continue..."), #klethi
  ("npc25_kingsupport_2a", "... continue..."), #klethi
  ("npc26_kingsupport_2a", "... continue..."), #klethi
  ...
  ("npc17_kingsupport_2b", "... do you intend to become a tyrannt and oppressor in your own right?"), #Sohayil
  ("npc18_kingsupport_2b", "... do you intend to become a tyrannt and oppressor in your own right?"), #Sohayil
  ("npc19_kingsupport_2b", "... do you intend to become a tyrannt and oppressor in your own right?"), #Sohayil
  ("npc20_kingsupport_2b", "... do you intend to become a tyrannt and oppressor in your own right?"), #Sohayil
  ("npc21_kingsupport_2b", "... do you intend to become a tyrannt and oppressor in your own right?"), #Sohayil
  ("npc22_kingsupport_2b", "... do you intend to become a tyrannt and oppressor in your own right?"), #Sohayil
  ("npc23_kingsupport_2b", "... do you intend to become a tyrannt and oppressor in your own right?"), #Sohayil
  ("npc24_kingsupport_2b", "... do you intend to become a tyrannt and oppressor in your own right?"), #Sohayil
  ("npc25_kingsupport_2b", "... do you intend to become a tyrannt and oppressor in your own right?"), #Sohayil
  ("npc26_kingsupport_2b", "... do you intend to become a tyrannt and oppressor in your own right?"), #Sohayil
  ...
  ("npc17_kingsupport_3", "Give me leave for a few weeks, and I'll do a little tour of my former employers' castles. I'll sing them a pretty song about what you'll do as {king/queen}, about all the ancient freedoms you'll restore -- let them rob their tenants and tax the merchants and fight their wars and spend themselves silly without a thought to tomorrow, as a noble ought! What do you say to that, captain?"), #klethi
  ...
  ("npc18_kingsupport_objection", "Oy -- Captain! I hear that Marnid's gone off to sing a pretty song to the merchants, on how you'll hand them Calradia on a silver platter for them to feast upon, smack their lips, and suck the marrow from the bones. I hope that's just a tale you're telling. A noble lord will at least toss a few coppers to the poor when he holds his feasts, and will make sure that the servants go home with full bellies. A merchant marries his daughter, and you'd be lucky to get a few crusts and scraps of gristle from the table. That's my experience, anyway."), #klethi
  ("npc19_kingsupport_objection", "Oy -- Captain! I hear that Marnid's gone off to sing a pretty song to the merchants, on how you'll hand them Calradia on a silver platter for them to feast upon, smack their lips, and suck the marrow from the bones. I hope that's just a tale you're telling. A noble lord will at least toss a few coppers to the poor when he holds his feasts, and will make sure that the servants go home with full bellies. A merchant marries his daughter, and you'd be lucky to get a few crusts and scraps of gristle from the table. That's my experience, anyway."), #klethi
  ("npc20_kingsupport_objection", "Oy -- Captain! I hear that Marnid's gone off to sing a pretty song to the merchants, on how you'll hand them Calradia on a silver platter for them to feast upon, smack their lips, and suck the marrow from the bones. I hope that's just a tale you're telling. A noble lord will at least toss a few coppers to the poor when he holds his feasts, and will make sure that the servants go home with full bellies. A merchant marries his daughter, and you'd be lucky to get a few crusts and scraps of gristle from the table. That's my experience, anyway."), #klethi
  ...
  ("npc22_kingsupport_objection", "Oy -- Captain! I hear that Marnid's gone off to sing a pretty song to the merchants, on how you'll hand them Calradia on a silver platter for them to feast upon, smack their lips, and suck the marrow from the bones. I hope that's just a tale you're telling. A noble lord will at least toss a few coppers to the poor when he holds his feasts, and will make sure that the servants go home with full bellies. A merchant marries his daughter, and you'd be lucky to get a few crusts and scraps of gristle from the table. That's my experience, anyway."), #klethi
  ("npc23_kingsupport_objection", "Oy -- Captain! I hear that Marnid's gone off to sing a pretty song to the merchants, on how you'll hand them Calradia on a silver platter for them to feast upon, smack their lips, and suck the marrow from the bones. I hope that's just a tale you're telling. A noble lord will at least toss a few coppers to the poor when he holds his feasts, and will make sure that the servants go home with full bellies. A merchant marries his daughter, and you'd be lucky to get a few crusts and scraps of gristle from the table. That's my experience, anyway."), #klethi
  ("npc24_kingsupport_objection", "Oy -- Captain! I hear that Marnid's gone off to sing a pretty song to the merchants, on how you'll hand them Calradia on a silver platter for them to feast upon, smack their lips, and suck the marrow from the bones. I hope that's just a tale you're telling. A noble lord will at least toss a few coppers to the poor when he holds his feasts, and will make sure that the servants go home with full bellies. A merchant marries his daughter, and you'd be lucky to get a few crusts and scraps of gristle from the table. That's my experience, anyway."), #klethi
  ("npc25_kingsupport_objection", "Oy -- Captain! I hear that Marnid's gone off to sing a pretty song to the merchants, on how you'll hand them Calradia on a silver platter for them to feast upon, smack their lips, and suck the marrow from the bones. I hope that's just a tale you're telling. A noble lord will at least toss a few coppers to the poor when he holds his feasts, and will make sure that the servants go home with full bellies. A merchant marries his daughter, and you'd be lucky to get a few crusts and scraps of gristle from the table. That's my experience, anyway."), #klethi
  ("npc26_kingsupport_objection", "Oy -- Captain! I hear that Marnid's gone off to sing a pretty song to the merchants, on how you'll hand them Calradia on a silver platter for them to feast upon, smack their lips, and suck the marrow from the bones. I hope that's just a tale you're telling. A noble lord will at least toss a few coppers to the poor when he holds his feasts, and will make sure that the servants go home with full bellies. A merchant marries his daughter, and you'd be lucky to get a few crusts and scraps of gristle from the table. That's my experience, anyway."), #klethi
...
#
  ...
  ("npc16_fief_acceptance", "{sire/my lady}. I... Never would have thought this could ever happen...  I will do my best to ensure the prosperity of my people!"), #klethi  
  ("npc17_fief_acceptance", "Oh, that's most generous of you, {sire/my lady}. I've been in and out of many a great hall or manor -- not always with the master's permission, I should add -- but I never thought I'd own one myself. Let me think... When I collect my first year's rents, what baubles shall I buy myself?"), #klethi  
  ...
  ("npc20_fief_acceptance", "Oh, that's most generous of you, {sire/my lady}. I've been in and out of many a great hall or manor -- not always with the master's permission, I should add -- but I never thought I'd own one myself. Let me think... When I collect my first year's rents, what baubles shall I buy myself?"), #klethi  
  ("npc21_fief_acceptance", "Oh, that's most generous of you, {sire/my lady}. I've been in and out of many a great hall or manor -- not always with the master's permission, I should add -- but I never thought I'd own one myself. Let me think... When I collect my first year's rents, what baubles shall I buy myself?"), #klethi  
  ("npc22_fief_acceptance", "Oh, that's most generous of you, {sire/my lady}. I've been in and out of many a great hall or manor -- not always with the master's permission, I should add -- but I never thought I'd own one myself. Let me think... When I collect my first year's rents, what baubles shall I buy myself?"), #klethi  
  ("npc23_fief_acceptance", "Oh, that's most generous of you, {sire/my lady}. I've been in and out of many a great hall or manor -- not always with the master's permission, I should add -- but I never thought I'd own one myself. Let me think... When I collect my first year's rents, what baubles shall I buy myself?"), #klethi  
  ("npc24_fief_acceptance", "Oh, that's most generous of you, {sire/my lady}. I've been in and out of many a great hall or manor -- not always with the master's permission, I should add -- but I never thought I'd own one myself. Let me think... When I collect my first year's rents, what baubles shall I buy myself?"), #klethi  
  ("npc25_fief_acceptance", "Oh, that's most generous of you, {sire/my lady}. I've been in and out of many a great hall or manor -- not always with the master's permission, I should add -- but I never thought I'd own one myself. Let me think... When I collect my first year's rents, what baubles shall I buy myself?"), #klethi  
  ("npc26_fief_acceptance", "Oh, that's most generous of you, {sire/my lady}. I've been in and out of many a great hall or manor -- not always with the master's permission, I should add -- but I never thought I'd own one myself. Let me think... When I collect my first year's rents, what baubles shall I buy myself?"), #klethi  
  ...
  ("npc17_woman_to_woman", "The men of this realm will not give you anything, You must sieze it, just as my mother had Siezed her freedom from her swadian slavers."), #klethi
  ("npc18_woman_to_woman", "The men of this realm will not give you anything, You must sieze it, just as my mother had Siezed her freedom from her swadian slavers."), #klethi
  ("npc19_woman_to_woman", "The men of this realm will not give you anything, You must sieze it, just as my mother had Siezed her freedom from her swadian slavers."), #klethi
  ("npc20_woman_to_woman", "The men of this realm will not give you anything, You must sieze it, just as my mother had Siezed her freedom from her swadian slavers."), #klethi
  ("npc21_woman_to_woman", "The men of this realm will not give you anything, You must sieze it, just as my mother had Siezed her freedom from her swadian slavers."), #klethi
  ("npc22_woman_to_woman", "The men of this realm will not give you anything, You must sieze it, just as my mother had Siezed her freedom from her swadian slavers."), #klethi
  ("npc23_woman_to_woman", "The men of this realm will not give you anything, You must sieze it, just as my mother had Siezed her freedom from her swadian slavers."), #klethi
  ("npc24_woman_to_woman", "The men of this realm will not give you anything, You must sieze it, just as my mother had Siezed her freedom from her swadian slavers."), #klethi
  ("npc25_woman_to_woman", "The men of this realm will not give you anything, You must sieze it, just as my mother had Siezed her freedom from her swadian slavers."), #klethi
  ("npc26_woman_to_woman", "Take it, Justice is greater than a name, even if that name is Rolf..."), #klethi
  ...
  ("npc17_turn_against", "{playername}...  If we must fight, let us get this over with."), #Sohayil
  ("npc18_turn_against", "{playername}...  If we must fight, let us get this over with."), #Sohayil
  ("npc19_turn_against", "{playername}...  If we must fight, let us get this over with."), #Sohayil
  ("npc20_turn_against", "{playername}...  If we must fight, let us get this over with."), #Sohayil
  ("npc21_turn_against", "{playername}...  If we must fight, let us get this over with."), #Sohayil
  ("npc22_turn_against", "{playername}...  If we must fight, let us get this over with."), #Sohayil
  ("npc23_turn_against", "{playername}...  If we must fight, let us get this over with."), #Sohayil
  ("npc24_turn_against", "{playername}...  If we must fight, let us get this over with."), #Sohayil
  ("npc25_turn_against", "{playername}...  If we must fight, let us get this over with."), #Sohayil
  ("npc26_turn_against", "{playername}...  If we must fight, let us get this over with."), #Sohayil
