...
##  ("peasant","Peasant",icon_peasant,0,fac_commoners,merchant_personality,[(trp_farmer,1,6),(trp_peasant_woman,0,7)]),
  ("slaves","Slaves",icon_peasant|carries_goods(2),0,fac_outlaws,merchant_personality,[(trp_haradian_recruit,1,5),(trp_haradian_surviver,1,5)]),


  ("black_khergit_raiders","Blood Khergit Raiders",icon_khergit_horseman_b|carries_goods(2),0,fac_black_khergits,bandit_personality,[(trp_black_khergit_horseman,50,200)]),
  ("dark_knights","Order of the Light",icon_vaegir_knight|carries_goods(2),0,fac_dark_knights,bandit_personality,[(trp_dark_guard,1,5),(trp_black_guard,1,5),(trp_dark_knight,2,5),(trp_black_knight,3,5)]),

  ("horde","Undead Horde",icon_peasant|carries_goods(2),0,fac_undeads,bandit_personality,[(trp_undead_walker,100,200),(trp_undead_horseman,5,50),(trp_undead,100,200),(trp_hell_knight,5,50)]),

  ("pilgrims","settlers",icon_peasant|carries_goods(2),0,fac_kingdom_8,bandit_personality,[(trp_settler,20,50)]),
...
# Reinforcements
  ...
  ("kingdom_7_reinforcements_a", "{!}kingdom_7_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_macon_hoplite,7,14)]),
  ("kingdom_7_reinforcements_b", "{!}kingdom_7_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_macon_hoplite,5,10)]),
  ("kingdom_7_reinforcements_c", "{!}kingdom_7_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_macon_band,3,5)]),

  ("kingdom_8_reinforcements_a", "{!}kingdom_8_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_settler,7,14)]),
  ("kingdom_8_reinforcements_b", "{!}kingdom_8_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_settler,3,7),(trp_conquistadore,2,3)]),
  ("kingdom_8_reinforcements_c", "{!}kingdom_8_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_conquistadore,3,5)]),
...
##  ("kingdom_5_reinforcements_c", "kingdom_5_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_rhodok_sergeant,3,7),(trp_rhodok_veteran_spearman,2,5),(trp_rhodok_veteran_crossbowman,2,5)]),
  ...
  ("undead_lair" ,"Graveyard",icon_bandit_lair|carries_goods(2)|pf_is_static|pf_hide_defenders,0,fac_neutral,bandit_personality,[(trp_undead,15,58)]),
  ("dark_knight_lair" ,"Dark Knight Camp",icon_bandit_lair|carries_goods(2)|pf_is_static|pf_hide_defenders,0,fac_neutral,soldier_personality,[(trp_dark_knight,15,58)]),
  ("black_khergit_lair" ,"Blood Khergit Camp",icon_bandit_lair|carries_goods(2)|pf_is_static|pf_hide_defenders,0,fac_neutral,soldier_personality,[(trp_black_khergit_horseman,15,58)]),
