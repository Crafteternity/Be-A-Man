...
#  bridge_a
  ...
  ("undead_spawn_point"  ,"undead_sp",pf_disabled|pf_is_static, no_menu, pt_none, fac_undeads,0,ai_bhvr_hold,0,(47.1, -73.3),[(trp_looter,15,0)]),
  ("black_khergit_spawn_point"  ,"the steppes",pf_disabled|pf_is_static, no_menu, pt_none, fac_black_khergits,0,ai_bhvr_hold,0,(47.1, -73.3),[(trp_looter,15,0)]),
  ("dark_knights_spawn_point"  ,"the tundra",pf_disabled|pf_is_static, no_menu, pt_none, fac_dark_knights,0,ai_bhvr_hold,0,(47.1, -73.3),[(trp_looter,15,0)]),

  ("settler_spawn_point"  ,"the coast",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(47.1, -73.3),[(trp_looter,15,0)]),

  ("slaves_spawn_point"   ,"slaves_sp",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(26, 77),[(trp_looter,15,0)]),
