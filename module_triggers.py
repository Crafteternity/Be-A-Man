...
#    ]),
  ...
  (5.7, 0, 0.0, 
  [
    (store_num_parties_of_template, reg2, "pt_horde"),    
    (lt, reg2, 10)
  ],
  [
    (set_spawn_radius, 1),
    (spawn_around_party, "p_town_16", "pt_horde"),
  ]),
  ##Bloodkhirs
  (5.7, 0, 0.0, 
  [
    (store_num_parties_of_template, reg2, "pt_black_khergit_raiders"),    
    (lt, reg2, 8)
  ],
  [
    (set_spawn_radius, 1),
    (spawn_around_party, "p_town_10","pt_black_khergit_raiders"),
  ]),
    ##Dark Knights
  (5.7, 0, 0.0, 
  [
    (store_num_parties_of_template, reg2, "pt_dark_knights"),    
    (lt, reg2, 8)
  ],
  [
    (set_spawn_radius, 1),
    (spawn_around_party, "p_town_8", "pt_dark_knights"),
  ]),

      ##Slaves
  (5.7, 0, 0.0, 
  [
    (store_num_parties_of_template, reg2, "pt_slaves"),    
    (lt, reg2, 100)
  ],
  [
    (set_spawn_radius, 1),
    ...
    (spawn_around_party, ":selected_town", "pt_slaves"),
  ]),
